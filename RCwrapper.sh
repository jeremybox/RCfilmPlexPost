...
echo "RCwrapper script start: $1" >> /home/user/Logs/RCfilmPlexPost.log
...
/home/user/RCfilmPlexPost/./RCfilmPlexPost.py "$1"

echo "RCwrapper script end: $1" >> /home/user/Logs/RCfilmPlexPost.log
